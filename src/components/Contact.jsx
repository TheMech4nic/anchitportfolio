...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Anchit Mishra",
					reply_to: user_email,
					to_email: "mishraanchit02@gmail.com",
	...
	return (
        ...
        <div className='relative z-0 intro-bg w-screen  mt-12'>   
			<div className='intro-text contact overflow-x-hidden pt-12 mt-8 ' id='contact'>
				<div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl' >
					<p>REACH OUT TO ME</p>
					<h2 className='text-5xl font-extrabold mt-2 introText-highlighted'>Contact.</h2>
					<form
						ref={formRef}
